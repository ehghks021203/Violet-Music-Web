...
function MainPage({ PlayMusic, AddMusic }) {
    ...
    useEffect(() => {
        ...
        if (!isLoggedIn) {
            axios.post("https://blue.kku.ac.kr/music-list.php", {})
        ...
        // 로그인 상태일 때 음악 리스트 불러오기
            ...
            axios.post("https://blue.kku.ac.kr/music-list-login.php", {
                'email': email,
            })
            .then(function(response) {
                if (Array.isArray(response.data.message)) {
        ...
        // 앨범 리스트 불러오기
        axios.post("https://blue.kku.ac.kr/album-list.php", {})
        .then(function(response) {
    ...
    const popularClick = () => {
        if (!isLoggedIn) {
            axios.post("https://blue.kku.ac.kr/musicListPopular.php", {})
            .then(function(response) {
                console.log(JSON.stringify(response.data));
                if (Array.isArray(response.data.message)) {
