...
import MypageProfileModal from '/var/www/html/music-app/src/components/MypageProfileModal.js';

import { ReactComponent as MusicPlay } from "/var/www/html/music-app/src/assets/imgs/Play.svg";
import { ReactComponent as MusicAdd } from "/var/www/html/music-app/src/assets/imgs/Add.svg";
import { ReactComponent as MusicLike } from "/var/www/html/music-app/src/assets/imgs/Like.svg";
import { ReactComponent as MusicLikeClick } from "/var/www/html/music-app/src/assets/imgs/LikeOn.svg";
...
function MyPage({ createPlaylistOn, setCreatePlaylistOn, PlayMusic, AddMusic }) {
    ...
    useEffect(() => {
        ...
        if(isLoggedIn){
            ...
            axios.post("https://blue.kku.ac.kr/userInfo.php", {
                'nickname': user,
            })
            ...
            axios.post("https://blue.kku.ac.kr/myprofile.php", {
                'email': email,
            }).then(function(response){
        ...
        if (state === 'recently-played'){
            axios.post("https://blue.kku.ac.kr/mypageRecent.php", {
            'nickname': user,
            'email': email
            })
            .then(function(response) {
            ...
            axios.post("https://blue.kku.ac.kr/userLike.php", {
                'nickname': user,
                'email':email
            })
            .then(function(response) {
        ...
        // 플레이리스트 목록 가져오기
        axios.post("https://blue.kku.ac.kr/playlist.php", {
            'type':'list',
            'nickname': user
        })
        .then(function(response) {
    ...
    useEffect(() => {
        if(isLoggedIn){
        const email = localStorage.getItem('email').replace(/^"(.*)"$/, '$1');
        axios.post("https://blue.kku.ac.kr/frButtonCheck.php", {
            'email': email,
            'nickname': user
        })
        .then(function(response){
    ...
    const onFollowButton = () => {
        ...
        if (buttonText === 'Follow'){
            ...
            axios.post("https://blue.kku.ac.kr/friend.php", {
                'nickname': user,
                'email':email
            })
            .then(function (response) {
            ...
            axios.post("https://blue.kku.ac.kr/friendDel.php", {
                'nickname': user,
                'email':email
            })
            .then(function (response) {
