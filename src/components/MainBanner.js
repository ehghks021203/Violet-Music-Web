...
import { ReactComponent as BannerNext } from "/var/www/html/music-app/src/assets/imgs/BannerNext.svg";
import { ReactComponent as BannerPrev } from "/var/www/html/music-app/src/assets/imgs/BannerPrev.svg";
...
function MainBanner() {
    ...
    useEffect(() => {
        axios.post("https://blue.kku.ac.kr/song-genre.php", {})
