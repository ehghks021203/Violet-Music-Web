...
import { ReactComponent as PlayerPrevious } from "/var/www/html/music-app/src/assets/imgs/player/Previous.svg";
import { ReactComponent as PlayerPlay } from "/var/www/html/music-app/src/assets/imgs/player/Play.svg";
import { ReactComponent as PlayerPause } from "/var/www/html/music-app/src/assets/imgs/player/Pause.svg";
import { ReactComponent as PlayerNext } from "/var/www/html/music-app/src/assets/imgs/player/Next.svg";
import { ReactComponent as PlayerShuffle } from "/var/www/html/music-app/src/assets/imgs/player/Shuffle.svg";
import { ReactComponent as PlayerShuffleOn } from "/var/www/html/music-app/src/assets/imgs/player/ShuffleOn.svg";
import { ReactComponent as PlayerReplay } from "/var/www/html/music-app/src/assets/imgs/player/Replay.svg";
import { ReactComponent as PlayerReplayOn } from "/var/www/html/music-app/src/assets/imgs/player/ReplayOn.svg";
import { ReactComponent as PlayerVolume } from "/var/www/html/music-app/src/assets/imgs/player/MusicVolume.svg";
import { ReactComponent as PlayerMute } from "/var/www/html/music-app/src/assets/imgs/player/MusicMute.svg";
import { ReactComponent as PlayerLike } from "/var/www/html/music-app/src/assets/imgs/player/Like.svg";
import { ReactComponent as PlayerLikeClick } from "/var/www/html/music-app/src/assets/imgs/LikeOn.svg";
import { ReactComponent as PlayerLyrics } from "/var/www/html/music-app/src/assets/imgs/player/Lyrics.svg";
import { ReactComponent as PlayerTimer } from "/var/www/html/music-app/src/assets/imgs/player/Timer.svg";
import { ReactComponent as MusicDelete } from "/var/www/html/music-app/src/assets/imgs/Delete.svg";
...
export const Player = forwardRef((props, ref) => {
    ...
    function MusicAddAndPlay(music) {
        ...
        if(isLoggedIn){
            ...
            axios.post("https://blue.kku.ac.kr/mypage.php", {
                'title': music.title,
                'email': email
            })
    ...
    const handleLikeClick = () => {
        if (isLoggedIn) {
            const email = localStorage.getItem('email').replace(/^"(.*)"$/, '$1');
            axios.post("https://blue.kku.ac.kr/likeCheck.php", {
                'title': music.title,
                'email': email
            })
            .then(function(response) {
                if (response.data.status === "success") {
                    axios.post("https://blue.kku.ac.kr/likeDel.php", {
                        'title': music.title,
                        'email': email
                    })
                    .then(function(response) {
                    ...
                    axios.post("https://blue.kku.ac.kr/like.php", {
                        'title': music.title,
                        'email': email
                    })
                    .then(function(response) {
